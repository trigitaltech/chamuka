...
export const GALLERY_ITEMS = [
  ...
  { id: 18, title: "Chief Chamuka departing to Uganda", category: "Community", size: "1x1" as const, image: "/gallery/chief-departs-uganda.jpg", type: "image" as const, description: "Chief Chamuka VI departs for Uganda on an official YPA invitation to strengthen youth, agriculture, and infrastructure partnerships." },
] as const;
